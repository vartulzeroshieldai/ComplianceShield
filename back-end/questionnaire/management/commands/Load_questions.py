# questionnaire/management/commands/load_questions.py
# Description: A custom Django command to populate the database with the new, full questionnaire structure.

from django.core.management.base import BaseCommand
from questionnaire.models import Category, SubCategory, Question

# Complete data extracted from "GAP Assessment Questionnaire 2.docx"
QUESTIONNAIRE_DATA = [
    {
        "category": "1. Governance, Leadership & Policy",
        "subcategories": [
            {
                "name": "Core Policy Framework",
                "questions": [
            ...
            {
                "name": "Additional Policy Governance Questions",
                "questions": [
    ...
    {
        "category": "2. Risk Management & Change Control",
        "subcategories": [
            {
            ...
            {
                "name": "Enhanced Risk Management Questions",
                "questions": [
            ...
            {
                "name": "Change Control and Impact Assessment",
                "questions": [
    ...
    {
        "category": "3. Asset & Information Lifecycle Management",
        "subcategories": [
            {
            ...
            {
                "name": "Comprehensive Asset Management Questions",
                "questions": [
    ...
    {
        "category": "4. Access Control & User Management",
        "subcategories": [
            {
            ...
            {
                "name": "Advanced Access Control Questions",
                "questions": [
            ...
            {
                "name": "Session and Authentication Management",
                "questions": [
    ...
    {
        "category": "5. Data Protection, Privacy & Retention",
        "subcategories": [
            {
                "name": "Core Privacy Framework",
                "questions": [
            ...
            {
                "name": "Enhanced Privacy and Data Protection Questions",
                "questions": [
    ...
    {
        "category": "6. Security Controls & Technology Measures",
        "subcategories": [
            {
            ...
            {
                "name": "Advanced Security Technology Questions",
                "questions": [
            ...
            {
                "name": "System Hardening and Configuration Management",
                "questions": [
    ...
    {
        "category": "7. Third-Party & Supplier Management",
        "subcategories": [
            {
            ...
            {
                "name": "Comprehensive Supplier Management Questions",
                "questions": [
                    ...
                    "Do you regularly review and update supplier contracts to reflect evolving regulatory requirements and security standards?",
    ...
    {
        "category": "8. Incident, Breach Response & Preparedness",
        "subcategories": [
            {
            ...
            {
                "name": "Enhanced Incident Management Questions",
                "questions": [
    ...
    {
        "category": "9. Training, Culture & Awareness",
        "subcategories": [
            {
            ...
            {
                "name": "Comprehensive Training and Culture Questions",
                "questions": [
    ...
    {
        "category": "10. Business Continuity, Resilience & Physical Security",
        "subcategories": [
            {
            ...
            {
                "name": "Enhanced Resilience and Continuity Questions",
                "questions": [
    ...
    {
        "category": "11. Monitoring, Auditing & Continuous Improvement",
        "subcategories": [
            {
                "name": "Audit and Review Framework",
                "questions": [
            ...
            {
                "name": "Advanced Monitoring and Improvement Questions",
                "questions": [
            ...
            {
                "name": "Continuous Monitoring and Intelligence",
                "questions": [
    ...
    {
        "category": "12. Advanced/Industry- or Tech-Specific Controls",
        "subcategories": [
            {
            ...
            {
                "name": "Healthcare and Medical Data (HIPAA/HITRUST)",
                "questions": [
            ...
            {
                "name": "Cloud and Software as a Service",
                "questions": [
            ...
            {
                "name": "Critical Infrastructure and NIS2",
                "questions": [
    ...
    {
        "category": "13. Ethics, Transparency & Societal Impact",
        "subcategories": [
            {
                "name": "Ethical Framework and Governance",
                "questions": [
            ...
            {
                "name": "Enhanced Ethics and Impact Questions",
                "questions": [
                    ...
                    "Do you maintain ethical guidelines for emerging technologies and novel use cases?"
                ]
            },
            {
    ...
    {
        "category": "14. Emerging Technologies and Future Readiness",
        "subcategories": [
            {
                "name": "Innovation and Technology Risk Management",
                "questions": [
            ...
            {
                "name": "Future Regulatory Preparedness",
                "questions": [
...
class Command(BaseCommand):
    help = 'Loads the new, structured questionnaire into the database.'

    def handle(self, *args, **options):
        # Clear existing data to prevent conflicts and duplicates
        Question.objects.all().delete()
        SubCategory.objects.all().delete()
        Category.objects.all().delete()
        self.stdout.write(self.style.WARNING('Cleared existing questions, subcategories, and categories.'))

        for cat_order, cat_data in enumerate(QUESTIONNAIRE_DATA, 1):
            # Use a more specific name for the category variable to avoid confusion
            category_name = cat_data['category']
            # Remove the leading number and period for a cleaner name if it exists
            if '.' in category_name:
                clean_name = category_name.split('.', 1)[1].strip()
            else:
            ...
            self.stdout.write(self.style.SUCCESS(f'Processing category: "{category.name}"'))

            for sub_cat_order, sub_cat_data in enumerate(cat_data['subcategories'], 1):
                subcategory, _ = SubCategory.objects.get_or_create(
                    category=category,
                    name=sub_cat_data['name'],
                    defaults={'order': sub_cat_order}
                )
                
                questions_to_create = []
                for q_order, q_text in enumerate(sub_cat_data['questions'], 1):
                ...
                self.stdout.write(f'  - Loaded {len(questions_to_create)} questions for subcategory: "{subcategory.name}"')

        self.stdout.write(self.style.SUCCESS('Successfully loaded all new questionnaire data.'))
